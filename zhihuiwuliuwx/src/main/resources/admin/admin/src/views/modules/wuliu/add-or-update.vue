<template>
 ...
 -->
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物流公司" prop="wuliuCourierName">
                       <el-input v-model="ruleForm.wuliuCourierName"
                                 placeholder="物流公司" clearable  :readonly="ro.wuliuCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物流公司" prop="wuliuCourierName">
                           <el-input v-model="ruleForm.wuliuCourierName"
                                     placeholder="物流公司" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物流单号" prop="wuliuCourierNumber">
                       <el-input v-model="ruleForm.wuliuCourierNumber"
                                 placeholder="物流单号" clearable  :readonly="ro.wuliuCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物流单号" prop="wuliuCourierNumber">
                           <el-input v-model="ruleForm.wuliuCourierNumber"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="物流路线" prop="wuliuText">
                        <el-input type="textarea"  :readonly="ro.wuliuText" v-model="ruleForm.wuliuText" placeholder="物流路线"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuliuText" label="物流路线" prop="wuliuText">
                            <span v-html="ruleForm.wuliuText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.wuliuContent"  label="物流详情" prop="wuliuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.wuliuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wuliuContent" label="物流详情" prop="wuliuContent">
                            <span v-html="ruleForm.wuliuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   wuliuText: [
                              { required: true, message: '物流路线不能为空', trigger: 'blur' },
                          ],
                   wuliuContent: [
                              { required: true, message: '物流详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            if (this.$route.query.yonghuId != null &&
				this.$route.query.shangpinOrderCourierName != null &&
				this.$route.query.shangpinOrderCourierNumber != null){
				this.ro.wuliuCourierName = true
				this.ro.wuliuCourierNumber = true
				
				this.ruleForm.wuliuCourierName = this.$route.query.shangpinOrderCourierName
				this.ruleForm.wuliuCourierNumber = this.$route.query.shangpinOrderCourierNumber
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.wuliuContent = _this.ruleForm.wuliuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.wuliuContent = this.ruleForm.wuliuContent.replaceAll(this.$base.url,"");
                        this.$http({
