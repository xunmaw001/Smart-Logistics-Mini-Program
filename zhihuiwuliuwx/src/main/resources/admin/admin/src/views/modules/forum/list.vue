        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '司机名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.sijiName" placeholder="司机名称" clearable></el-input>
                    </el-form-item>
                                                                                 
                    <el-form-item :label="contents.inputTitle == 1 ? '司机类型' : ''">
                        <el-select v-model="searchForm.sijiTypes" placeholder="请选择司机类型">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                                    v-for="(item,index) in sijiTypesSelectSearch"
                                    v-bind:key="index"
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zhihuiwuliuwx/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.sijiTypes!= '' && this.searchForm.sijiTypes!= undefined) {
                    params['sijiTypes'] = this.searchForm.sijiTypes
                }
                ...
                //查询级联表搜索条件所有列表
                this.$http({
                    url: "dictionary/page?dicCode=siji_types&page=1&limit=100",
                    method: "get",
                    page: 1,
                    limit: 100,
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.sijiTypesSelectSearch = data.data.list;
                    }
                });
                //查询当前表搜索条件所有列表
            },
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.sijiTypes = el.sijiTypes;
                            forum.sijiContent = el.sijiContent;
                            forum.dataDelete = el.dataDelete;
                            forum.createTime = el.createTime;
