<template>
	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <view v-if="isAuth('shangpinCommentback','报表')" @tap="openChartDialog" :style="{padding:'0 10rpx',lineHeight:'80rpx',width:'auto',height:'80rpx',fontSize:'28rpx',color:'rgba(239, 239, 239, 1)',backgroundColor:btnColor[0],borderColor:btnColor[0]}">
                报表
            </view>
    ...
    <!--  回复模态框 -->
        ...
        <view class="list b-b" v-for="(item, index) in list" :key="index"
            ...
            <view class="wrapper" style="padding: 10rpx 3rpx;margin-left: 25upx;margin-top: 10upx;">
                ...
                <uni-icons v-show="isAuth('shangpinCommentback','回复')" style="float: right;" @tap="onReply(item.id)" type="chat-filled" size="20">
                </uni-icons>
	...
	export default {
		...
		methods: {
			...
			async submitReplyData(){
                ...
                await this.$api.update(`shangpinCommentback`, data);
                this.$refs.replyDeliver.close()
                this.mescroll.num = 1
