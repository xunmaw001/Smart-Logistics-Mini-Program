<template>
	<view>
        ...
        <view class="username">
			...
			<text v-if="forum.sijiId != null">
				 发布人：{{forum.sijiName}}（司机）
			</text>
			...
			<view class="uni-article__comment-box" v-for="comment in commentData" :key="comment.id" >
				<view class="article-meta">
					<view class="article-header-image">
                        ...
                        <image v-if="comment.sijiId != null" class="image" :src="baseUrl+comment.sijiPhoto" mode="widthFix"></image>
					...
					<view class="article-header-content">
						<view class="article-header-title">
							...
							<text v-if="comment.sijiId != null">{{comment.sijiName}}</text>
