        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zhihuiwuliuwx/upload/wuliuMuBan.xls"
                        >批量导入物流信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('wuliu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="wuliuCourierName"
                                   header-align="center"
                                   label="物流公司">
                        <template slot-scope="scope">
                            {{scope.row.wuliuCourierName}}
                        </template>
                    </el-table-column>

                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="wuliuCourierNumber"
                                   header-align="center"
                                   label="物流单号">
                        <template slot-scope="scope">
                            {{scope.row.wuliuCourierNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="wuliuText"
                                      ...
                                      label="物流路线">
                        <template slot-scope="scope">
                            <span v-if="scope.row.wuliuText != null &&scope.row.wuliuText.length>10">
                                {{scope.row.wuliuText.slice(0,10)}}...
                            </span>
                            <span v-else>
                                {{scope.row.wuliuText}}
                            </span>
                ...
                <el-dialog title="发货" :visible.sync="deliverVisible" width="30%">
                    <el-form>
                        <el-form-item label="物流公司">
                            <el-input v-model="wuliuCourierName" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item label="物流单号">
                            <el-input v-model="wuliuCourierNumber" autocomplete="off"></el-input>
                        </el-form-item>
                    </el-form>
...
<script>
    ...
    export default {
        ...
        return {
            ...
            deliverId:null,
			//快递单号
            wuliuCourierNumber:null,
			//快递公司
            wuliuCourierName:null,
			//模态框状态
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '余额': 'newMoney',
                //本表字段
                     '物流公司': "wuliuCourierName",
                     '物流单号': "wuliuCourierNumber",
                     '物流路线': "wuliuText",
                     '添加时间': "insertTime",
            },
