...
<view class="list-box style3"
    ...
    <view @tap="onDetailTap('shangpin',product.id)" v-for="(product,index) in shangpinList"
        ...
        <image
                ...
                :src="baseUrl+product.shangpinPhoto"></image>
        <view class="list-item-body"
            ...
            <view
                    ...
                    class="list-item-title">{{product.shangpinName}}
            </view>
        </view>
    </view>
</view>
