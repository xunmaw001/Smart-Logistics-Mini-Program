    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物流公司" prop="shangpinOrderCourierName">
                       <el-input v-model="ruleForm.shangpinOrderCourierName"
                                 placeholder="物流公司" clearable  :readonly="ro.shangpinOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="物流公司" prop="shangpinOrderCourierName">
                           <el-input v-model="ruleForm.shangpinOrderCourierName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单物流单号" prop="shangpinOrderCourierNumber">
                       <el-input v-model="ruleForm.shangpinOrderCourierNumber"
                                 placeholder="订单物流单号" clearable  :readonly="ro.shangpinOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单物流单号" prop="shangpinOrderCourierNumber">
                           <el-input v-model="ruleForm.shangpinOrderCourierNumber"
                                     placeholder="订单物流单号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinOrderCourierNumber: [
                              { required: true, message: '订单物流单号不能为空', trigger: 'blur' },
                          ],
                   shangpinOrderTypes: [
