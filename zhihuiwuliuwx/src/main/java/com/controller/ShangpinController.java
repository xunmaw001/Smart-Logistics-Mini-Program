    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        for(Integer id:ids){
            ...
            shangpinEntity.setDataDelete(2);
...
//                            shangpinEntity.setDataDelete(1);//逻辑删除字段
...
//                            shangpinEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //商品编号
                        List<ShangpinEntity> shangpinEntities_shangpinUuidNumber = shangpinService.selectList(new EntityWrapper<ShangpinEntity>().in("shangpin_uuid_number", seachFields.get("shangpinUuidNumber")).eq("data_delete", 1));
    ...
    */
    ...
    public R add(@RequestBody ShangpinEntity shangpin, HttpServletRequest request){
        ...
        Wrapper<ShangpinEntity> queryWrapper = new EntityWrapper<ShangpinEntity>()
            ...
            .eq("shangxia_types", shangpin.getShangxiaTypes())
            .eq("data_delete", shangpin.getDataDelete())
