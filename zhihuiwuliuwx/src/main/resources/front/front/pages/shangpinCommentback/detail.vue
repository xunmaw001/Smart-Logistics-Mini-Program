	...
	<script>
		export default {
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.detail('shangpinCommentback', this.shangpinCommentbackId);
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
                                ...
                                // uni.setStorageSync('shangpinCommentbackId', _this.shangpinCommentbackId);
                                // _this.$utils.jump('/pages/shangpinCommentbackYuyue/add-or-update');
