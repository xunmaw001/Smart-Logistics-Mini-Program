	...
	<script>
		export default {
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.detail('shangpinCollection', this.shangpinCollectionId);
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
                                ...
                                // uni.setStorageSync('shangpinCollectionId', _this.shangpinCollectionId);
                                // _this.$utils.jump('/pages/shangpinCollectionYuyue/add-or-update');
