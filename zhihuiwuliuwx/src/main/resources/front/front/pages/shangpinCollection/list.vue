<template>
	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <view v-if="isAuth('shangpinCollection','报表')" @tap="openChartDialog" :style="{padding:'0 10rpx',lineHeight:'80rpx',width:'auto',height:'80rpx',fontSize:'28rpx',color:'rgba(239, 239, 239, 1)',backgroundColor:btnColor[0],borderColor:btnColor[0]}">
                报表
            </view>
...
<view class="uni-product-list"
      :style='{"padding":"20rpx 0","margin":"0","borderColor":"red","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":0,"borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'
      style="box-sizing: border-box;display: flex;flex-wrap: wrap;align-content: flex-start;">
    <view @tap="onDetailTap(product)" class="uni-product"
          :style='{"padding":"0px 20rpx 0","boxShadow":"0 0 12rpx var(--publicSubColor)","margin":"0 1% 20rpx 2%","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","borderRadius":"20rpx","borderWidth":"2rpx","width":"47%","borderStyle":"solid","height":"auto"}'
          v-for="(product,index) in list" :key="index">
        <view class="uni-product-title"
              :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"#333","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","fontSize":"30rpx","lineHeight":"40rpx","borderStyle":"solid"}'>
            {{product.shangpinName}}
        </view>
        <view v-if="product.shangpinNewMoney" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"red","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","fontSize":"25rpx","lineHeight":"40rpx","borderStyle":"solid"}'>
            <text style="font-size: 30rpx;">￥</text>{{product.shangpinNewMoney}}
        </view>
        <view v-else-if="product.shangpinValue" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","color":"#333","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","fontSize":"25rpx","lineHeight":"40rpx","borderStyle":"solid"}'>
            {{product.shangpinValue}}
        </view>
        <image
                :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0","borderColor":"red","backgroundColor":"rgba(255,0,0,0)","borderRadius":"8rpx","borderWidth":"0","width":"95%","borderStyle":"solid","height":"260rpx"}'
                mode="aspectFill" class="uni-product-image"
