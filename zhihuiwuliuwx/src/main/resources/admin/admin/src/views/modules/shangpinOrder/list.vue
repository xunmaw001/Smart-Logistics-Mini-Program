                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zhihuiwuliuwx/upload/shangpinOrderMuBan.xls"
                        >批量导入商品订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinOrder','导入导出')"
...
&& sessionTable=='users'" type="primary" icon="el-icon-reading" size="mini"
            ...
            >发货</el-button>
			<el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 103" type="primary" icon="el-icon-reading" size="mini" @click="wuliuAdd(scope.row)">添加物流信息</el-button>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '物流公司': "shangpinOrderCourierName",
                     '订单物流单号': "shangpinOrderCourierNumber",
        ...
        methods: {
			...
			deliver(){
				...
				if(this.shangpinOrderCourierNumber == ""
					|| this.shangpinOrderCourierNumber == null
					|| this.shangpinOrderCourierNumber == "null"){
						return this.$message.error("订单物流单号不能为空");
				}
				...
				this.$router.push(
					{
						...
						query: {
							...
							shangpinOrderCourierName: data.shangpinOrderCourierName,
							shangpinOrderCourierNumber: data.shangpinOrderCourierNumber
						}
					}
				)
			},
