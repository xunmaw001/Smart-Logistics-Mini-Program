<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='siji'"  label='司机名称' prop="sijiName">
               <el-input v-model="ruleForm.sijiName"  placeholder='司机名称' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='siji'"  label='联系方式' prop="sijiPhone">
               <el-input v-model="ruleForm.sijiPhone"  placeholder='联系方式' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='siji'"  label='邮箱' prop="sijiEmail">
               <el-input v-model="ruleForm.sijiEmail"  placeholder='邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='siji'"  label='司机类型' prop="sijiTypes">
                 <el-select v-model="ruleForm.sijiTypes"  placeholder='请选择司机类型'>
                     <el-option
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='siji'"  label="司机介绍" prop="sijiContent">
                 <editor
...
// 注册表 司机 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.sijiPhone)&& 'siji'==this.flag){
                         ...
                         if((!this.ruleForm.sijiTypes)&& 'siji'==this.flag){
                             this.$message.error('司机类型不能为空');
                             return
                         }

                         if((!this.ruleForm.sijiContent)&& 'siji'==this.flag){
