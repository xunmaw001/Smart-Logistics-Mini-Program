        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="车辆状态" prop="zhuangtaiTypes">
                        <el-select v-model="ruleForm.zhuangtaiTypes" :disabled="ro.zhuangtaiTypes" placeholder="请选择车辆状态">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="车辆状态" prop="zhuangtaiValue">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.cheliangContent"  label="车辆详情" prop="cheliangContent">
